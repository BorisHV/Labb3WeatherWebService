...
public class Data {
    ...
    private com.example.labb3smhi.MET.Next1Hours next1Hours;
    ...
    @JsonProperty("next_1_hours")
    public com.example.labb3smhi.MET.Next1Hours getNext1Hours() {
        return next1Hours;
    }

    @JsonProperty("next_1_hours")
    public void setNext1Hours(com.example.labb3smhi.MET.Next1Hours next1Hours) {
